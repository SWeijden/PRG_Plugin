...
#include "PRG_PluginEditorMode.generated.h"
 ...
 */
UCLASS()
class UPRG_PluginEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_PRG_PluginEditorModeId;

	//static FString SimpleToolName;
	//static FString InteractiveToolName;
	static FString RoomToolName;

	UPRG_PluginEditorMode();
	virtual ~UPRG_PluginEditorMode();
